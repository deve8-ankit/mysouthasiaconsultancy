...
const DrawerContent = React.forwardRef(({ className, children, ...props }, ref) => (<DrawerPortal>
    <DrawerOverlay />
    <DrawerPrimitive.Content ref={ref} className={cn("flex fixed inset-x-0 bottom-0 z-50 flex-col mt-24 h-auto border rounded-t-[10px] bg-background", className)} {...props}>
...
const DrawerFooter = ({ className, ...props }) => (<div className={cn("flex flex-col gap-2 p-4 mt-auto", className)} {...props}/>);
DrawerFooter.displayName = "DrawerFooter";
const DrawerTitle = React.forwardRef(({ className, ...props }, ref) => (<DrawerPrimitive.Title ref={ref} className={cn("text-lg font-semibold tracking-tight leading-none", className)} {...props}/>));
