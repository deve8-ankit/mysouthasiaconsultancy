...
const TabsList = React.forwardRef(({ className, ...props }, ref) => (<TabsPrimitive.List ref={ref} className={cn("inline-flex justify-center items-center p-1 h-10 rounded-md bg-muted text-muted-foreground", className)} {...props}/>));
