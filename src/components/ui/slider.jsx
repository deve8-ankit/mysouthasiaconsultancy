...
const Slider = React.forwardRef(({ className, ...props }, ref) => (<SliderPrimitive.Root ref={ref} className={cn("flex relative items-center w-full select-none touch-none", className)} {...props}>
