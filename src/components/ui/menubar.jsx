...
const Menubar = React.forwardRef(({ className, ...props }, ref) => (<MenubarPrimitive.Root ref={ref} className={cn("flex items-center p-1 space-x-1 h-10 rounded-md border bg-background", className)} {...props}/>));
