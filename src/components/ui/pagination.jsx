...
const Pagination = ({ className, ...props }) => (<nav role="navigation" aria-label="pagination" className={cn("flex justify-center mx-auto w-full", className)} {...props}/>);
Pagination.displayName = "Pagination";
const PaginationContent = React.forwardRef(({ className, ...props }, ref) => (<ul ref={ref} className={cn("flex flex-row gap-1 items-center", className)} {...props}/>));
...
const PaginationEllipsis = ({ className, ...props }) => (<span aria-hidden className={cn("flex justify-center items-center w-9 h-9", className)} {...props}>
