...
const BreadcrumbEllipsis = ({ className, ...props }) => (<span role="presentation" aria-hidden="true" className={cn("flex justify-center items-center w-9 h-9", className)} {...props}>
