...
const Card = React.forwardRef(({ className, ...props }, ref) => (<div ref={ref} className={cn("rounded-lg border shadow-sm bg-card text-card-foreground", className)} {...props}/>));
...
const CardTitle = React.forwardRef(({ className, ...props }, ref) => (<div ref={ref} className={cn("text-2xl font-semibold tracking-tight leading-none", className)} {...props}/>));
